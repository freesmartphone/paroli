...
class MsgsWrite(tichy.Application):
    ...
    def err_callback(self, *args, **kargs):
        ...
        #self.item_list.add_callback("details", "*", self.open_msg_detail_window)
        
        #self.messages_list.add_callback("*", "embryo", self.self_test)
        #self.item_list.add_callback("quick_reply", "*", self._quick_reply)

        #self.item_list.add_callback("save", "*", self.open_save_contact_window)
        #self.messages_list.add_callback("*", "embryo", self.self_test)
